...
public class mock_company extends AppCompatActivity {
    ...
    private String[] global = { "웹에 관련된 프로젝트 무엇을 했는지 말해주세요.", "사용해본 웹 호스팅은 ?", "방과후 수업때 했던 내용을 간략하게 설명해주세요", "무엇을 배웠고, 무엇을 하고 싶은지에 관해 자기소개를 해보세요",
            "학교 정규수업 이외에 전공에 대해\n각자 자신이 하고 싶었던 것이 무엇인가요?", "자신이 하고 싶은 전공과\n관련지어 자기소개를 해주세요", "자신의 미래에 대해 자기소개하기", "어노테이션(@)와 주석의 차이",
            "자바 swing의 특징과 상속의 특징", "디자인 패턴을 아냐", "우리 회사가 어디에 위치하는지 아나요?", "php를 잘 모르는 것 같은데 회사에서\n바로 php쓰라하면 어떻게 하실건가요?", "프로젝트를 진행하다 보면\n친구랑 많이 싸우진 않았나요?",
    ...
    private String[] navi = { "간단한 자기 소개와 지원동기를 말씀해주세요", "스택과 큐의 차이점에 대해서 말해보세요", "자신이 가장 잘 하는 언어는 무엇인가요?", "공룡이라는 주제를 주고 그거에 대한 게임을 기획해보아라",
            ...
            "내가 같이 면접 본 친구들보다 잘하는 점은?", "다른 사람들과의 차별적인\n프로젝트를 진행했던 경험은 무엇인가요?", "우리 회사가 꼭 뽑아야 하는 이유는?", "가장 힘들었던 프로젝트는 무엇인가요? 그 이유는요?" };
    private String[] shin = { "자기소개", "아르바이트 경험이나 슬펐거나 기뻤던 자신의 에피소드를 들려주세요.", "반학생이 매우 적죠?\n반에서 자기 위치는 뭐라고 생각해요?", "IT분야가 아닌 다른 분야로 가게되면 어떡할 것인가?",
    ...
    private String[] sqi = { "사람은 왜 사는가", "왜 '면접자 자신'을 뽑아야하는가\n이유를 들어 말해주세요.", "자신과 지내기 힘들다고 생각한 사람의 유형은 무엇인가?", "역사란 무엇인가",
    ...
    private String[] covision = { "자기소개하기", "개발자라는 직업을 선택한 것에 확신하나요(후회하지 않나요)?", "본인의 장단점을 말씀해보세요.", "자신이 개발과 잘 맞는다고 생각하는 기준이 무엇인가?",
            ...
            "현재 IT트랜드는 무엇이라고 생각하는지", "좋은 회사란?", "인생에서 실패했던 경험이 있나요?", "자신의 비젼은?", "저녁 자기계발 시간이 중요하게 여겨지는\n추세인데 본인은 어떻게 생각하나요?",
